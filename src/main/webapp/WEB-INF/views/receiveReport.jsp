<%-- 
    Document   : receiveReport
    Created on : Jan 4, 2019, 11:08:55 PM
    Author     : Rezwana
--%>
...
<html lang="en">
    <head>
        ...
        <title>Admin - Invoice Receive</title>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Invoice-Receive</li>
                    </ol>

                    <div class="panel-body">

                        <form:form method="POST" action="receiveview" commandName="reportInputForm">

                            <table id="reptbl" width="350px" border="1">
                                <div class="form-group ">
                                    <label for="SaleId" class="control-label col-lg-3">Sale Id :</label>
                                    <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="SaleId" type="text" path="sid" required="true"></form:input>
                                        </div>
                                    </div>  
