<%-- 
    Document   : saledetailreportview
    Created on : Jan 10, 2019, 1:49:55 AM
    Author     : Rezwana
--%>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        ...
                        <form:form method="POST" action="SaledetailReportView" commandName="reportInputForm">
...
<!--                                    <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="Sale ID" type="text" path="SUBREPORT_DIR" required="true"></form:input>
                                        </div>-->
                                    </div>  
                                
                                <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="Sale ID" type="text" path="sid" required="true"></form:input>
                                        </div>
                                    </div>  
