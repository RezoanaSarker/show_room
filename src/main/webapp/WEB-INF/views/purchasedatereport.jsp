<%-- 
    Document   : purchasedatereport
    Created on : Jan 9, 2019, 2:10:25 AM
    Author     : Rezwana
--%>
...
<html lang="en">
    <head>
        ...
        <title>Admin - Purchase Report</title>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        ...
                        <form:form method="POST" action="purchasedateview" commandName="reportInputForm">
