<%-- 
    Document   : purchasedetailreportview
    Created on : Jan 10, 2019, 10:56:46 AM
    Author     : Rezwana
--%>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        ...
                        <form:form method="POST" action="PurchasedetailReportView" commandName="reportInputForm">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="Purchase Id" type="text" path="pid" required="true"></form:input>
                                        </div>
                                    </div>  
