...
<html>
    <head lang="en">
        ...
        <title>Admin - Invoice Payment</title>
    ...
    <body id="page-top" ng-app="organocartpackage" ng-controller="ProductController" >
        ...
        <form:form method="POST" action="paymentView" commandName="reportInputForm">

            <table id="reptbl" width="350px" border="1">
                 <tr>
                    <td colspan="2"><form:errors path="pid" cssClass="error"/></td> </tr>
                <tr>
                     <tr>
                    <td colspan="2"><form:errors path="sname" cssClass="error"/></td> </tr>
                <tr>
              
                    <td>
                        Enter Report Title <form:input path="pid" />
                         Enter Report Title <form:input path="sname" />
                        ...
                        <form:form method="POST" action="paymentView" commandName="reportInputForm">
                            ...
                            <table id="reptbl" width="350px" border="1">
                                <div class="form-group ">
                                    <label for="PurchaseId" class="control-label col-lg-3">Purchase Id :</label>
                                    <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="PurchaseId" type="text" path="pid" required="true"></form:input>
                                        </div>
                                    </div>  

                                    <div class="form-group ">
                                        <label for="sname" class="control-label col-lg-3">Supplier Name :</label>
                                        <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="" type="text" path="sname" required="true"></form:input>
                                        </div>
                                    </div> 
                                    ...
                                    <form:button  type="submit" 
                                                  class="btn btn-info">Search-ReceivePayment</form:button>
