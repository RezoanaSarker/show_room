            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        ...
                        <form:form method="POST" action="ProductReportView" commandName="reportInputForm">

                            <table id="reptbl" width="350px" border="1">
                                <div class="form-group ">
                                    <label for="ProductPrice" class="control-label col-lg-3">Product Price :</label>
                                    <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="ProductPrice" type="text" path="productprice" required="true"></form:input>
                                        </div>
                                    </div>  
