<%-- 
    ...
    Created on : Dec 30, 2018, 9:25:27 AM
    Author     : Rezwana
--%>
...
<html lang="en">
    <head>
        ...
        <title>Admin - Add Purchase</title>
        ...
        <script>
            ...
            var cartproductlist = ${itemsincart1};

            angular.module('organocartpackage', []).controller('ProductController',
                    function ($scope) {
                        $scope.supplierslist = supplierslist;
    ...
    <body ng-app="organocartpackage" ng-controller="ProductController">
        <nav class="navbar navbar-expand navbar-dark bg-info static-top">
            ...
            <a class="navbar-brand mr-1 card-header" href="#">Fashion Fiesta Showroom</a>
          ...
          style="width: 90%; margin-top: 10px; margin-bottom: 10px">
            ...
            <div class="panel animated fadeInDown delay-05s" id="panel-1">
                <div class="panel-heading">
                    ...
                    <a href="showcartpage1"
                       style="color: #9ccc65; font-size: 19px"> <span
                            class="glyphicon glyphicon-shopping-cart"></span> <span
                            class="badge">${sessionScope.grandquantity2}</span>
                    </a>
                </div>--%>
                    <!-- end panel heading -->
                    <div class="panel-body">
                        <div class="formcontainer ">
                            ...
                            <form:form commandName="newpurchaseObject" action="addtocart1"
                                ...
                                <c:if test="${check}">
                                    <form:button id="editbuttons" type="submit" class="btn btn-success">Add
                                        Details</form:button>
                    ...
                    <table class="table table-striped table-responsive animated fadeInDown delay-05s">
                        ...
                        <c:if test="${!cartempty}">
                                ...
                                <tr scope="row" style="margin: 10px">
                                    ...
                                    <td><div class="input-group">
                                            <span class="input-group-btn"> <a
                                                    href="editquantity1?getproductid={{items.pid}}&value=decrease"
                                                ...
                                                <a
                                                    href="editquantity1?getproductid={{items.pid}}&value=increase"
                                    ...
                                    <td><a href="removeproductitem1?pid={{items.pid}}"
                            ...
                            <td><h4 class="pull-left">
                                    <b>Tk.${sessionScope.grandtotal1}</b>
                                </h4>
                            </td>
                            <%-- <td></td>--%>
                            </tfoot>
                    ...
                    <div class="panel-body">
                        <div class="formcontainer ">
                            ...
                            <form:form commandName="newpurchaseObject" action="addpurchasepage"
                                       enctype="multipart/form-data">
                                <div class="form-group">
                                    <select class="form-control" ng-model="supplierid" ng-options="x.supplierId as x.supplierName for x in supplierslist" required="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <form:input type="number" class="form-control"  path="billtotal" placeholder="Total-bill" required="true" value="${sessionScope.grandtotal1}" readonly="true" ></form:input>
                                    </div>
                                ...
                                <c:if test="${check}">
                                    <form:button id="editbuttons" type="submit"  name="Add" class="btn btn-primary">Confirm
                                    </form:button>
                                    <form:button id="removebuttons" type="reset" class="btn btn-danger">Reset
                                        Details</form:button>
                                </c:if>
