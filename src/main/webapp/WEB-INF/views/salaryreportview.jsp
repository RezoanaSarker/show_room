...
<html lang="en">
    <head>
        ...
        <title>Admin - salaryreport</title>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        ...
                        <form:form method="POST" action="SalaryReportView" commandName="reportInputForm">

                            <table id="reptbl" width="350px" border="1">
                                <div class="form-group ">
                                    <label for="StaffId" class="control-label col-lg-3">Staff Id :</label>
                                    <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="StaffId" type="text" path="empid" required="true"></form:input>
                                        </div>
                                    </div>  

                                   <%-- <div class="form-group ">
                                        <label for="sname" class="control-label col-lg-3">Showroom Name :</label>
                                        <div class="col-lg-6">
                                        <form:input class="form-control"
                        ...
                        <form:form method="POST" action="SalaryReportVieww" commandName="reportInputForm">

                            <table id="reptbl" width="350px" border="1">
                                <div class="form-group ">
                                    <label for="BasicSalary" class="control-label col-lg-3">Staff Basic Salary :</label>
                                    <div class="col-lg-6">
                                        <form:input class="form-control"
                                                    Placeholder="Basic Salary" type="text" path="bas" required="true"></form:input>
                                        </div>
                                    </div>  
