 ...
 */
package com.rezoana.show_room.config;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/showingshowroom").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/showproductpage").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/showcartpage1").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/showcartpage2").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/showingEmployeeinfo").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/showattendpage").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/showsalarytpage").access("hasRole('ROLE_ADMIN')")
